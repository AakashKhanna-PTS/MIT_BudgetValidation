 ...
 */
define(["SuiteScripts/pts_helper", "N/record", "N/redirect"], function (
  util,
  record,
  redirect
) {
  function onRequest(context) {
    try {
      var budgetId = context.request.parameters.recordid;
  ...
  // function processPOtoPR(POsearch, billDifference) {
  //   var POdifference = findDifference(billDifference, POsearch);
  //   var finalConsumedBudget =
  //     POdifference.addAmount + POdifference.nonLinkedTotal;
  //   var totalAmountToReduce = POdifference.difference;

  //   log.debug("finalConsumedAmountPOOOO", finalConsumedBudget);
  //   log.debug("totalAMountToReducePOOO", totalAmountToReduce);
  //   return finalConsumedBudget;
  // }
